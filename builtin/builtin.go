...
func ComponentList() map[string]func() interface{} {
	...
	_components["GoogleVoice"] = NewGoogleVoice
...
func ComponentInfos() map[string]Component {
	...
	result["VoiceDecoder"] = Component{
		Name:        "VoiceDecoder",
		Description: "VoiceDecoder Component",
		Icon:        "",
		Constructor: NewVoiceDecoder,
	}

	result["BaiduVoice"] = Component{
		Name:        "BaiduVoice",
	...
	result["GoogleVoice"] = Component{
		Name:        "GoogleVoice",
		Description: "GoogleVoice Component",
		Icon:        "",
		Constructor: NewGoogleVoice,
	}
